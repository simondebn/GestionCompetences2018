...
## Dépendances 
Toutes les dépendances nécessaires sont inclues dans le projet. Cependant vous trouverez l'intégralité des dépendances utilisées ainsi que leurs versions ci-dessous : 
